 ...
 */
public class MapListFragment extends Fragment implements ValueEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView= (RecyclerView) rootView.findViewById(R.id.mBlockdataView);
        RecyclerView.LayoutManager mLayoutManager=new LinearLayoutManager(getContext());
        mRecyclerView.setLayoutManager(mLayoutManager);

        FirebaseDatabase mDatabase=FirebaseDatabase.getInstance();
        DatabaseReference mDataRef=mDatabase.getReference("20170128");
        mDataRef.addValueEventListener(this);
        return rootView;
    }
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        mBlockDataAdapter = new BlockDataAdapter(mBlockDatas, getContext());
        mRecyclerView.setAdapter(mBlockDataAdapter);
    }
